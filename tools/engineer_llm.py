...
from models.artifacts import EngineerPack, PatchArtifact
from tools.llm_provider import GeminiDirectClient, LLMRequest
...
class GeminiEngineerClient:
    ...
    def _deterministic_patch(self, pack: EngineerPack) -> PatchArtifact:
        ...
        marker_one = f"{comment_prefix} ticketops: prototype patch suggestion"
        marker_two = f"{comment_prefix} ticketops: add explicit validation guard"
...
EngineerLLMClient = GeminiEngineerClient
