...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--tasks-path",
        default="/Users/myth/Documents/VSCode/Codetor/agentic_issue_resolution/samples/tasks.json",
        help="Path to simulation task JSON file.",
    )
    parser.add_argument(
        "--output-path",
        default="/Users/myth/Documents/VSCode/Codetor/agentic_issue_resolution/storage/poc_report.json",
