...
from agentic_issue_resolution.graph.context_bridge import (
    build_coding_brief,
    build_confluence_draft,
    build_jira_comment_draft,
)
from agentic_issue_resolution.models.api import ApprovalRequest, JiraWebhookPayload, RunStartResponse, ApprovalResponse
from agentic_issue_resolution.models.artifacts import (
    AuditorPack,
    CalendarProposal,
    CodingBrief,
    DecisionType,
...
from agentic_issue_resolution.models.state import ApprovalRecord, RunStatus, WorkflowState
from agentic_issue_resolution.models.validators import (
    apply_high_risk_strict_checks,
    validate_coding_brief,
    validate_patch_artifact,
    verify_patch_scope,
)
from agentic_issue_resolution.operate.categorizer import category_from_manager_output, estimate_category
...
from agentic_issue_resolution.tools.bitbucket import MockBitbucketClient, RealBitbucketClient
from agentic_issue_resolution.tools.calendar import GoogleCalendarClient, MockCalendarClient
from agentic_issue_resolution.tools.code_search import code_search
from agentic_issue_resolution.tools.confluence import MockConfluenceClient, RealConfluenceClient
from agentic_issue_resolution.tools.email import GoogleGmailClient, MockEmailClient
